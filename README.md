...
in this article he stated that for it to work a ZX-81 needed an extra 8K RAM at 8K to 16K, (the 8K following the ROM) and a Z80 that supported 8-bit refresh! Most Z80's at the time only supported 7-bit refresh counters (7-refresh address lines) but it seems you could buy Z80's that supported 8-bit refresh in 1986. I'm not sure whether modern (CMOS) Z80's also adapted 8-bit refresh.
